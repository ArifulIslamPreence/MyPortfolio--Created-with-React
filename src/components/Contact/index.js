      ...
      <div className="flex items-center justify-center flex-col md:flex-row ">
        <div className="flex-auto  md:w-32  sm:pl-0  overflow-visible">
          <form onSubmit={handleSubmit} data-aos={"slide-up"}>
            ...
            <p>
              or send a quick email to :</p>
            <p>
              mdarifulislampreence@gmail.com
            </p>
            <button
              disabled
              type="button"
        ...
        <div className="flex-auto w-full md:w-80  flex flex-col justify-center text-center items-center  gap-1">
          ...
          <div data-aos={"slide-up"} className="text-center mt-10">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              <div
                onClick={() =>
                  window.open("https://github.com/ArifulIslamPreence", "_blank")
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/ariful-islam-preence/",
                    "_blank"
                  )
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.facebook.com/preence.me/",
                    "_blank"
                  )
                }
              >
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              <div
                  onClick={() =>
                      window.open("mdarifulislampreence@gmail.com", "_blank")
                  }
              >
